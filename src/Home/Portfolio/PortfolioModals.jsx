              ...
              <div className="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="mx-4 font-semibold  col-span-2">
                  <div className="my-2">
                    ...
                    {/* {tags?.map((tag) => (
                      <button className="px-4 py-2 rounded-full bg-yellow-600 m-2 bg-[#]">
                        {tag}
                      </button>
                    ))} */}
                  </div>
                 ...
                 <div className="my-6 flex justify-center   ">
                   <a
                     ...
                     href="/#contact"
                     className="w-full text-center bg-gray-600 sm:w-3/6 sm:mx-auto mx-4 px-6 py-2 text-yellow-600 rounded-full bg-[#df6651]"
                   >
                     Contact me
                   </a>
                 </div>
...
// const PortfolioModal = ({ open, setOpen, portfolioData, tags, Languages }) => {
//   const [selectImg, setSelectImg] = useState("");
//   const {
//     projectType,
//     projectName,
